...
## 📋 Descripción
Sitio web desarrollado con HTML y CSS para la actividad de desarrollo web. Este proyecto es una landing page para una aplicación de portapapeles, basado en el desafío de Frontend Mentor.
...
- [Incluir capturas del desarrollo aquí]
